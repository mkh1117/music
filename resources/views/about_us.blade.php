...
<div class=" bg-dark"  id="column" >
    <div class="card col-2 " style="margin-top:1%; " id="c1">
      ...
      <div class="row " id="wrapper" style="margin-top:1%;">
        <div class="card col-lg-12 offset-lg-0 col-md-12 offset-md-0 col-sm-12 offset-sm-0 col-12 black p-5 d-flex flex-row shadow "  >
            <div class="d-flex align-items-center justify-content-between" style="flex-direction: column">
                <section id="about-us" style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px; border-radius: 8px;">
            <h1 class="h3" style="text-align: center; color:#f6f7f7">{{ $h1 }}</h1>
            <p style="color:#f6f7f7;" dir="rtl">
                پرشین تاپ موزیک با هدف ارائه بهترین و جدیدترین آهنگ‌های ایرانی و خارجی، فضایی جذاب و کاربرپسند برای علاقه‌مندان به موسیقی ایجاد کرده است. ما تلاش می‌کنیم مجموعه‌ای متنوع از موسیقی‌های محبوب و به‌روز را در اختیار شما قرار دهیم تا بتوانید از شنیدن آهنگ‌های دلخواهتان لذت ببرید.
            </p>
            <h3 class="h4" style="color:#f6f7f7; text-align: center">چرا پرشین تاپ موزیک؟</h3>
            <ul style="color:#f6f7f7; margin-left: 20px;" dir="rtl">
                <li>دسترسی آسان به جدیدترین آهنگ‌ها</li>
                <li>محیطی ساده و کاربرپسند</li>
                <li>امکان دانلود سریع و باکیفیت</li>
                <li>آرشیوی از آهنگ‌های قدیمی و ماندگار</li>
            </ul>
            <p style="color:#f6f7f7;" dir="rtl">
                ما معتقدیم که موسیقی مرزها را از بین می‌برد و یادآور لحظات زیبا در زندگی است. پرشین تاپ موزیک جایی است که هم ترانه‌های امروز را خواهید یافت و هم آهنگ‌هایی که شما را به خاطرات گذشته می‌برند.
            </p>
            <p style="text-align: center; font-weight: bold; color: #f6f7f7;" dir="rtl">
                به ما بپیوندید و از دنیای بی‌پایان موسیقی لذت ببرید!
            </p>
                </section>
      </div>
      </div>
