    ...
    <div class=" col-2 " style="margin-top:5%; " id="c1">
      ...
      <div id="c2" class=" col-2" style="margin-top:5%; background:linear-gradient(90deg,rgb(84, 83, 84)40%,rgb(110, 110, 112)60%,rgb(167, 167, 171)100%); ">
       ...
       <i class="bi bi-music-note-beamed">
        <a  style="text-decoration: none ;float:right; color:#000000;" href="/{{ $artist->name }}"><p > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-music-note" viewBox="0 0 16 16">
        ...
        <div class="row " id="wrapper" style="margin-top:5%;">
            ...
            @endif
                <audio src="/music/{{ $main->music }}" controls type="audio/mpeg" class="mx-auto col-md-12 col-12" style="margin-top: 10px;"></audio>
                </div>
           ...
           <?php $n=$page+2 ?>
            @for ($i=$page+1;$i<=$n;$i++)
                ...
                @endfor
                @if ($page!=$number_page)
            <a class="btn green " href="?page={{ $number_page }} " role="button" style="pading= 5px;">{{ $number_page }}</a>
                @endif
                </div>
            </div>
        </div>
