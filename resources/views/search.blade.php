...
<div class="offcanvas offcanvas-end" style="background-color: #050505;" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" dir="rtl">
    <div style=" padding: 0 0 0 16 px; display: flex ; justify-content: space-around">
      <h5 id="offcanvasRightLabel" class="text-white"><a class="navbar-brand text-white" href="/" dir="ltr"><svg height="50"   class="svgs"   xmlns="http://www.w3.org/2000/svg">
    ...
    <div class=" bg-dark"  id="column">
        ...
        <div class="row " id="wrapper" style="margin-top:1%;">
            ...
            <header class="card" style=" background:#000000;height:auto;">
                ...
                <a href="/" class="text-green" style="text-decoration: none ;color:#f6f7f7 " title="{{ $h1 }}">{{ $h1 }}</a>
                      </i>
            ...
            <div class="justify-content-center offset-3 linkDow">
                ...
                <audio preload="none" src="/music/{{ $main->music }}" controls type="audio/mpeg" class="mx-auto col-md-12 col-12" style="margin-top: 10px;">
                </div>
           ...
           <?php $n=$page+2 ?>
            @for ($i=$page+1;$i<=$n;$i++)
                ...
                @endfor
                @if ($page!=$number_page)
            <a class="btn green page" href="/search/{{ $search }}/?page={{ $number_page }} " role="button" style="pading= 5px;">{{ $number_page }}</a>
                @endif
                </div>
            </div>
        </div>
