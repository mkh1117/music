...
<div class="offcanvas offcanvas-end" style="background-color: #050505;" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" dir="rtl">
    <div style=" padding: 0 0 0 16 px; display: flex ; justify-content: space-around">
      <h5 id="offcanvasRightLabel" class="text-white"><a class="navbar-brand text-white" href="/" dir="ltr"><svg height="55" class="svgs" xmlns="http://www.w3.org/2000/svg">
        <text x="0%"  y="30" fill="#00a547"  class="sizesvg" style="font-family:myMulti">PERSIAN</text>
        <text x="43%" y="30" fill="grey"    font-size="20" class="sizesvg"    style="font-family:myMulti">TOP</text>
        <text x="65%" y="30" fill="#00a547" font-size="20" class="sizesvg" style="font-family:myMulti">MUSIC</text>
      </svg></a></h5>
...
<nav class="navbar navbar-expand-lg sticky-top navbar-light" style="background-color: #050505;">
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-flex-end" style="width: 10%" dir="rtl">
        <button id="auto" style="background:transparent;border-width: 0; margin-rigth: 1%;order: 1;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-search" viewBox="0 0 16 16">
            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
          </svg></button>
    ...
    <div class=" bg-dark" style="margin-top:10px; margin-bottom: 10px;">
      <div  class=" col-lg-12 col-12 col-md-12 col-sm-12 col-xl-12 offset-md-0 offset-lg-0 offset-xl-0 offset-sm-0" id="margin" >
        @foreach ($querys as $query)
            <a href="/top/{{ $query->key_out }}"  style="text-decoration: none; " class="" >
                <img src="/pictures/{{ $query->picture }}" class=" align-items-center justify-content-center mu-5   " data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ $query->text1 }} از {{ $query->text }}" alt="عکس" id="grade" >
            </a>
    ...
    <div class=" bg-dark"  id="column">
        <div class="card col-2 " style="margin-top:1%; " id="c1">
            ...
            <a href="/top/{{ $new->keyout }}" class="list-group-item  border1"><p style="margin-right:3%; margin-top:2%; " dir="rtl">دانلود اهنگ {{ $new->text1 }} از {{ $new->text }} </p></a></br>
            @endforeach
              </div>
          <div dir="rtl" id="c2" class="card col-2" style="margin-top:1%; background-color: #050505;padding: 20px 10px 10px 10px;">
                <div style="text-align:center;width: 100%;border-style: solid;  border-color: #ffffff; border-width: 1px; border-radius: 5px;">
        ...
        <div class="row " id="wrapper" style="margin-top:1%;">
            ...
            <header class="card" style=" background:#000000;height:auto;">
                <h1 class="h5" style="text-align:center;">
                    ...
                    @foreach ($tops as $top)
                <a href="/top/{{ $top->id }}" style="text-decoration: none ;color: #f6f7f7 " title="دانلود اهنگ {{ $top->text1 }} ">دانلود اهنگ {{ $top->text }} {{ $top->text1 }} </a>
                      </i>
            ...
            <div class="card col-lg-12 offset-lg-0 col-md-12 offset-md-0 col-sm-12 offset-sm-0 col-12 black p-5 d-flex flex-column shadow "  >
                ...
                <audio preload="none" src="/music/{{ $top->music }}" controls type="audio/mpeg" class="mx-auto col-md-12 col-12" style="margin-top: 10px;">
                </div>
